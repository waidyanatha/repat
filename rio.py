...
def cleanup_tweets(file="./data/rawtweets.csv"):
    ...
    if not os.path.exists(file):
        print("Cannot find raw twitter data in director ./data/ with name: "+file)
        error += 1
    else:
...
#    os.system(exstr)
    data_df=pd.read_csv("./data/"+conf.file_raw_extract_data,encoding='utf-16',sep='\t')
#    data_df=pd.read_csv('./nepal.txt',encoding='utf-16',sep='\t')
#d    data_df=pd.read_csv('./data/test200.txt',encoding='utf-16',sep='\t')
